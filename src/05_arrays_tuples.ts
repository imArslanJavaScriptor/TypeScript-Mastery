...
myArray.push("Grapes")
// console.log(myArray.push({name: "Ali"}))  // This will Throw Error
...
const persons: Person[] = [{personName: "Arslan King", personAge: 20}]
// If you want to make your array read only and restrict it so that nothing can be add to it pass readonly to it.
const readOnlyPerson: readonly Person[] = [{personName: "Meer Hadi", personAge: 25}]
...
const myCustomTuple: [string, number, boolean] = ['King', 10, true]

// Method 2: Vai Passing The Type Seprately
type MyCustomTupleType = [string, number, boolean]
const myCustomTuple2: MyCustomTupleType = ['King', 100, true]
